    ...
    <div key={elemento.id} className={styles.card}>
      ...
      <div className={styles.segCont}>
        <div className={styles.miniCont1}>
          ...
          <p className={styles.descCard}>{elemento.description}</p>
        </div>

        <div className={styles.miniCont2}>
          <p className={styles.precioCard}>Precio: ${elemento.price}</p>

          <p className={styles.precioCard}>Categoria: {elemento.category}</p>

          <p className={styles.precioCard}>Stock: {elemento.stock}</p>
          {elemento.stock > 0 ? (
            <ItemCountContainer
            ...
            <h3>No hay stock en este momento</h3>
          )}
        </div>
      </div>
    </div>
